...
export const metadata: Metadata = {
  title: "Website Development Company in Hong Kong | AEGIBIT",
  description: "AEGIBIT delivers secure, scalable software for businesses in Hong Kong. SOC 2 ready, OWASP-tested, deployed in weeks.",
  alternates: { canonical: "/locations/website-development-hong-kong" },
  openGraph: {
    title: "Website Development Company in Hong Kong | AEGIBIT",
    description: "Secure software for businesses in Hong Kong. Built by a cybersecurity company.",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-black text-white">
      <section className="mx-auto max-w-5xl px-6 py-24">
        ...
        <p className="mt-6 text-xl text-white/70 max-w-2xl">
          ...
          platforms for businesses in Hong Kong with security, compliance, and performance baked in from day one.
        </p>
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-2 text-white/60">Most Hong Kong projects ship in 4–8 weeks, not quarters.</p>
          </div>
        </div>
