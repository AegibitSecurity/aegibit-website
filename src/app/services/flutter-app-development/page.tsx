...
export const metadata: Metadata = {
  title: "Flutter App Development | AEGIBIT",
  description: "AEGIBIT delivers secure, scalable software using Flutter. SOC 2 ready, OWASP-tested, deployed in weeks.",
  alternates: { canonical: "/services/flutter-app-development" },
  openGraph: {
    title: "Flutter App Development | AEGIBIT",
    description: "Secure software using Flutter. Built by a cybersecurity company.",
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-black text-white">
      <section className="mx-auto max-w-5xl px-6 py-24">
        ...
        <h1 className="mt-3 text-4xl md:text-6xl font-bold leading-tight">
          Flutter App Development with Enterprise Security
        </h1>
        <p className="mt-6 text-xl text-white/70 max-w-2xl">
          ...
          platforms using Flutter with security, compliance, and performance baked in from day one.
        </p>
        ...
        <div className="mt-20 grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-2 text-white/60">Most Flutter projects ship in 4–8 weeks, not quarters.</p>
          </div>
        </div>

        <div className="mt-20 rounded-xl border border-white/10 bg-white/5 p-8">
          <h2 className="text-2xl font-bold">Why Flutter companies choose AEGIBIT</h2>
