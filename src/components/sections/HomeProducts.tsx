...
const PRODUCTS: Product[] = [
  ...
  },
  {
    id: "voicecore",
    name: "VoiceCore",
    tagline: "Voice-first business operations.",
    description:
      "Run your operations through natural-language commands. Hindi, Bengali, English — biometric voice auth, full ops automation. Design partners onboarding.",
    status: "EARLY ACCESS",
    icon: Mic,
    iconColor: "#3B82F6",
    href: "/contact?product=voicecore",
    ctaLabel: "Get Early Access",
  },
  {
    id: "aira",
    name: "Aira AI",
    tagline: "AI co-founder, in every product.",
    description:
      "Anomaly detection, cash-flow forecasting, natural-language queries — Aira sits inside PayMint, VoiceCore, and every future AEGIBIT product. Smarter with every customer.",
    status: "EMBEDDED",
    icon: Sparkles,
    iconColor: "#A855F7",
    href: "/products/paymint",
    ctaLabel: "See Aira in PayMint",
  },
  {
    id: "industry-os",
    name: "Industry OS",
