...
import { BarChart3, Users, Mail, Settings, Home, Sparkles, Send, Menu, X, GitBranch, Bot, Download, FlaskConical } from "lucide-react";
...
const NAV = [
  ...
  { href: "/dashboard/tool-activity", icon: FlaskConical, label: "Tool Activity" },
